        ...
        <div className="w-full px-4">
          <div className="flex items-center h-16">
            ...
            <div className="hidden justify-center md:flex items-center gap-8 flex-1">
              ...
              <Link to="/products" className="text-gray-700 hover:text-orange-500 font-medium transition">
                Products
              </Link>
              <Link to="/vendors" className="text-gray-700 hover:text-orange-500 font-medium transition">
                Vendors
              </Link>
            ...
            <div className="flex items-center gap-4 ml-auto">
              {/* Search Bar */}
              <form onSubmit={handleSearch} className="hidden lg:flex items-center bg-gray-100 rounded-full px-4 py-2">
                <input
                  type="text"
